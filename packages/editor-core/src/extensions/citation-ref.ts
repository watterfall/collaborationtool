...
// Per ADR-0001 §2.3.3 only the ID is in Y.Doc; citation metadata lives in
// Postgres (`citation` table). The label is a denormalised UI cache that
// the editor refreshes when the editor mounts.
