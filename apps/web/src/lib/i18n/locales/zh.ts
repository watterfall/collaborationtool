...
export const zh = {
  ...
  vault: {
    ...
    nightHeading: '夜间想法 / Night artifacts',
    nightEmpty: '还没有夜间产出——凌晨三点的念头值得一个不被监视的家。',
    nightEmptyEn: 'No night artifacts yet — your 3am ideas deserve an unwatched home.',
    newThought: '新产出 / New artifact',
    night: {
      ...
      cancel: '取消 / Cancel',
      kindLabel: '类型 / Kind：',
      metaphorSource: '源域（如"液滴"）/ Source domain',
      metaphorTarget: '目标域（如"细胞凝聚体"）/ Target domain',
      metaphorMapping: '结构映射：哪些关系迁移 / Structural mapping',
      sketchMedium: '媒介 / Medium',
      sketchContent: '内容引用（URL 或内联）/ Content ref',
      sketchCaption: '说明（让别人能进入草图）/ Caption',
      contradictionType: '矛盾类型 / Contradiction type',
      contradictionPoleA: '一极 / Pole A',
      contradictionPoleB: '另一极 / Pole B',
      contradictionSignificance: '张力意义：为何重要 / Significance',
      tePremise: '前提设定（"设想一只猫在密封盒中…"）/ Premise',
    },
  },
  landing: {
    meta: {
