...
export const en: LocaleDict = {
  ...
  vault: {
    ...
    nightHeading: 'Night artifacts / 夜间想法',
    nightEmpty: 'No night artifacts yet — your 3am ideas deserve an unwatched home.',
    nightEmptyEn: '还没有夜间产出——凌晨三点的念头值得一个不被监视的家。',
    newThought: 'New artifact / 新产出',
    night: {
      ...
      cancel: 'Cancel / 取消',
      kindLabel: 'Kind / 类型:',
      metaphorSource: 'Source domain (e.g. "droplets") / 源域',
      metaphorTarget: 'Target domain (e.g. "condensates") / 目标域',
      metaphorMapping: 'Structural mapping — which relations transfer / 结构映射',
      sketchMedium: 'Medium / 媒介',
      sketchContent: 'Content ref (URL or inline) / 内容引用',
      sketchCaption: 'Caption — let others enter the sketch / 说明',
      contradictionType: 'Contradiction type / 矛盾类型',
      contradictionPoleA: 'Pole A / 一极',
      contradictionPoleB: 'Pole B / 另一极',
      contradictionSignificance: 'Significance — why it matters / 张力意义',
      tePremise: 'Premise ("Imagine a cat in a sealed box…") / 前提设定',
    },
  },
  landing: {
    meta: {
